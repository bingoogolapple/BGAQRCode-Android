...
public class Generatectivity extends AppCompatActivity {
    ...
    private void createChineseQRCode() {
        QRCodeEncoder.encodeQRCode("王浩", BGAQRCodeUtil.dp2px(Generatectivity.this, 150), new QRCodeEncoder.Delegate() {
            @Override
    ...
    private void createEnglishQRCode() {
        QRCodeEncoder.encodeQRCode("bingoogolapple", BGAQRCodeUtil.dp2px(Generatectivity.this, 150), Color.parseColor("#ff0000"), new QRCodeEncoder.Delegate() {
            @Override
            public void onEncodeQRCodeSuccess(Bitmap bitmap) {
    ...
    private void createChineseQRCodeWithLogo() {
        QRCodeEncoder.encodeQRCode("王浩", BGAQRCodeUtil.dp2px(Generatectivity.this, 150), Color.parseColor("#795dbf"), BitmapFactory.decodeResource(Generatectivity.this.getResources(), R.mipmap.logo), new QRCodeEncoder.Delegate() {
            @Override
            public void onEncodeQRCodeSuccess(Bitmap bitmap) {
    ...
    private void createEnglishQRCodeWithLogo() {
        QRCodeEncoder.encodeQRCode("bingoogolapple", BGAQRCodeUtil.dp2px(Generatectivity.this, 150), Color.parseColor("#0000ff"), BitmapFactory.decodeResource(Generatectivity.this.getResources(), R.mipmap.logo), new QRCodeEncoder.Delegate() {
            @Override
            public void onEncodeQRCodeSuccess(Bitmap bitmap) {
